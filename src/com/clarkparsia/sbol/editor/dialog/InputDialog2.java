 ...
 */
public abstract class InputDialog2<T> extends JDialog {
	...
	protected InputDialog2(final Component parent, String title) {
	...
	protected abstract SBOLDocument getSelection();
