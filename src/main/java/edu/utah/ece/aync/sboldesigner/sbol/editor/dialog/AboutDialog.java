...
import edu.utah.ece.aync.sboldesigner.sbol.editor.SBOLDesignerMetadata;
...
public class AboutDialog {
	...
	public static void show(final Component parent) {
		...
		JEditorPane ep = new JEditorPane(
                        ...
                        + "<br><br>" + "This project is made possible by: "
                        + "<br><br>" + SBOLDesignerMetadata.AUTHORS.replace("&", "&amp;") + "."
                        + "<br><br>" + "Developers:"
                        + "<ul>"
                        + "<li>Michael Zhang</li>"
                        + "<li>Chris Myers</li>"
