...
import edu.utah.ece.aync.sboldesigner.sbol.editor.dialog.MessageDialog;
import edu.utah.ece.aync.sboldesigner.sbol.editor.dialog.PartEditDialog;
import edu.utah.ece.aync.sboldesigner.sbol.editor.dialog.RegistryInputDialog;
import edu.utah.ece.aync.sboldesigner.sbol.editor.dialog.RootInputDialog;
import edu.utah.ece.aync.sboldesigner.sbol.editor.dialog.UploadDialog;
import edu.utah.ece.aync.sboldesigner.sbol.editor.event.DesignChangedEvent;
import edu.utah.ece.aync.sboldesigner.sbol.editor.event.DesignLoadedEvent;
import edu.utah.ece.aync.sboldesigner.sbol.editor.event.FocusInEvent;
import edu.utah.ece.aync.sboldesigner.sbol.editor.event.FocusOutEvent;
import edu.utah.ece.aync.sboldesigner.sbol.editor.event.PartVisibilityChangedEvent;
import edu.utah.ece.aync.sboldesigner.sbol.editor.event.SelectionChangedEvent;
