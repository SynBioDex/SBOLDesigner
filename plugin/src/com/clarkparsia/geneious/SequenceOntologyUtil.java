...
public class SequenceOntologyUtil {
	...
	public static final URI DELETION = URI.create("SO_0000159");

	public static final URI INSERTION = URI.create("SO_0000667");

	public static final URI INVERSION = URI.create("SO_1000036");

	public static final URI COMPLEX_SUBSTITUTION = URI.create("SO_1000005");

	public static final URI POINT_MUTATION = URI.create("SO_1000008");

	public static final URI A_to_G_transition = URI.create("SO_1000015");
	public static final URI G_to_A_transition = URI.create("SO_1000016");
	public static final URI C_to_T_transition = URI.create("SO_1000011");
	public static final URI T_to_C_transition = URI.create("SO_1000013");
	public static final URI A_to_C_transversion = URI.create("SO_1000024");
	public static final URI A_to_T_transversion = URI.create("SO_1000025");
	public static final URI G_to_C_transversion = URI.create("SO_1000026");
	public static final URI G_to_T_transversion = URI.create("SO_1000027");
	public static final URI C_to_A_transversion = URI.create("SO_1000019");
	public static final URI C_to_G_transversion = URI.create("SO_1000020");
	public static final URI T_to_A_transversion = URI.create("SO_1000021");
	public static final URI T_to_G_transversion = URI.create("SO_1000022");
	...
	private static void initTypeMappings() {
		...
		GENEIOUS_TYPES.put(Parts.RBS.getRole(), "RBS");
		...
		GENEIOUS_TYPES.put(Parts.SCAR.getRole(), "Scar");
